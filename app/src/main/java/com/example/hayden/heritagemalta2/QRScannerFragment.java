...
public class QRScannerFragment extends Fragment implements ZXingScannerView.ResultHandler {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onQRScannerFragmentInteraction(uri);
        }
    }
    ...
    public void handleResult(Result result) {
        ...
        MediaPlayer mp = MediaPlayer.create(getContext(),R.raw.qrcodenotification);
        ...
        intent2.putExtra("STRING_EXTRA",result.toString());
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onQRScannerFragmentInteraction(Uri uri);
    }
}
